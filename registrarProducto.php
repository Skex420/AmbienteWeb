...
<body>
    <form action="" method="post">
        <div class="container-fluid" onsubmit="return ValidarCampos();">
            <h2>Admin</h2>
            <br>
            <div class="row">
                <div class="col-1">
                    ...
                    Producto
                    <input type="text" id="txtIdProducto" name="txtIdProducto" class="form-control" value="" required
                ...
                <div class="col-2">
                    ...
                    Producto
                    <input type="text" id="txtProducto" name="txtProducto" class="form-control" value="" required
                ...
                <div class="col-2">
                    ...
                    Precio
                    <input type="text" id="txtValor" name="txtValor" class="form-control" value="" required
